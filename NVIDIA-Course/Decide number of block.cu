...
int main()
{
    ...
    size_t number_of_blocks = (N + threads_per_block - 1) / threads_per_block; //(1000+256-1)/256 = 1255/256 = 4.90 = 4
    //So, if we can fix/know the number of threads then we can easily calculate number_of_blocks with this formula
